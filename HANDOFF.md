...
1. **species_profile curation — np≥2 tiers ALL DONE. np=1 tier IN PROGRESS (A150–A190 done)** *(at 5,956 / 2026-06-10; 1,062 np=1 candidates remaining)*
   - **Next batch A191 — verified clean top-24 (np=1, from DB query): Hirundapus caudacutus, Hister japonicus, Homidia socia, Homoeocerus marginiventris, Homoeusa japonica, Hoplammophila aemulans, Hoplitocoris lewisi, Hosta fortunei, Hosta longissima, Hyacinthoides hispanica, Hyastenus kyusyuensis, Hydnellum scabrosum, Hydrelia nisaria, Hydropsyche orientalis, Hydrotaea ignava, Hygophum reinhardtii, Hylochares harmandi, Hylocomiastrum umbratum, Hylotelephium erythrostictum, Hylotelephium verticillatum, Hymenasplenium hondoense, Hymenophyllum oligosorum, Hymenoscyphus fructigenus, Hypena claripennis.** (Re-run the np=1 query for fresh en/zh detail before writing; Hirundapus caudacutus = White-throated Needletail (+eBird, fastest bird); 2 Hosta plantain lilies; Hyacinthoides hispanica = Spanish bluebell; 2 Hylotelephium stonecrops; Hymenophyllum = filmy fern; Hydropsyche = net-spinning caddisfly.)
