...
1. **species_profile curation — np≥2 tiers ALL DONE. np=1 tier IN PROGRESS (A150–A187 done)** *(at 5,884 / 2026-06-08; 1,134 np=1 candidates remaining)*
   - **Next batch A188 — verified clean top-24 (np=1, from DB query): Gonocephalum persimile, Gonocephalum sexuale, Goodyera repens, Goodyera schlechtendaliana, Grammistes sexlineatus, Granulifusus niponicus, Graphomya rufitibia, Grateloupia turuturu, Grewia biloba, Grus monacha, Gryllodes sigillatus, Guepinia helvelloides, Gyalolechia flavovirescens, Gymnocarpium jessoense, Gymnopus subsulphureus, Gymnoscelis esakii, Gymnosphaera podophylla, Gymnura japonica, Habronyx insidiator, Habrosyne aurorina, Halcyon coromanda, Halenia corniculata, Haliclystus tenuis, Halieutaea stellata.** (Re-run the np=1 query for fresh en/zh detail before writing; Grus monacha = Hooded Crane + Halcyon coromanda Ruddy Kingfisher = BIRDS (+eBird); Grammistes sexlineatus = sixline soapfish (toxic skin); 2 Goodyera jewel orchids; Guepinia helvelloides = apricot jelly fungus; Gymnura japonica = Japanese butterfly ray; Grateloupia turuturu = red seaweed (invasive); Gryllodes sigillatus = banded cricket.)
