...
1. **species_profile curation — np≥2 tiers ALL DONE. np=1 tier IN PROGRESS (A150–A224 done)** *(~6,810 / 2026-06-14; 208 np=1 candidates remaining)*
   ...
   - **Next batch A225 — from Stethojulis bandanensis / next alpha** (re-run the np=1 query for the fresh top-26 + en detail; alphabet now mid-S range — reef fish/molluscs, moths, fungi/lichens, plants, some birds).
