...
1. **species_profile curation — np≥2 tiers ALL DONE. np=1 tier IN PROGRESS (A150–A183 done)** *(at 5,788 / 2026-06-08; 1,230 np=1 candidates remaining)*
   - **Next batch A184 — verified clean top-24 (np=1, from DB query): Eupithecia subfumosa, Eupithecia tenuisquama, Euplexidia angusta, Euplica turturina, Euploea mulciber, Euplynes batesi, Euprymna morsei, Eupsilia unipuncta, Eurystomus orientalis, Euspira pallida, Eutelia adulatricoides, Eutelia geyeri, Eutetrapha chrysochloris, Eutrema japonicum, Euwallacea validus, Euzopherodes oberleae, Evernia mesomorpha, Eviota abax, Exallias brevis, Exolaternula liautaudi, Exolaternula spengleri, Eysarcoris guttigerus, Facelis retusa, Falagria caesa.** (Re-run the np=1 query for fresh en/zh detail before writing; Eutrema japonicum = WASABI; Euploea mulciber = Striped Blue Crow butterfly; Eurystomus orientalis = Oriental Dollarbird; Euprymna morsei = bobtail squid; Euwallacea validus = ambrosia beetle; Evernia mesomorpha = a lichen.)
