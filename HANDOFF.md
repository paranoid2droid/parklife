...
1. **species_profile curation — np≥3 DONE. np=2 tier essentially CLEARED (A104–A148 done)** *(at 5,009 / 2026-06-01; 15 anomaly candidates remaining)*
   - **Next batch (A143) — the verified clean top-24 (np=2) are: Solenostoma pyriflorum, Solidobalanus socialis, Sorbus gracilis, Sparganium subglobosum, Spinacia oleracea, Spondylus squamosus, Spurilla braziliana, Stachyurus praecox var. macrocarpus, Steccherinum ciliolatum, Steccherinum ochraceum, Stemmatophora valida, Stemonitis axifera, Stemonitis splendens, Stenodema calcarata, Stephanitis pyrioides, Stephoblemmus minor, Stercorarius longicaudus/parasiticus/pomarinus, Stichodactyla tapetum, Stigmatonotum geniculatum, Streptopelia decaocto (シラコバト=Eurasian Collared Dove), Striglina cancellata, Strobilomyces strobilaceus.** Run the Active #1 query, dump 24 rows to a file, READ the full file, copy names EXACTLY. DO NOT reconstruct names from memory — that wasted A135/A137/A140/A142. See ⚠️ PROCESS LESSON.
