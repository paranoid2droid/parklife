...
1. **species_profile curation — np≥2 tiers ALL DONE. np=1 tier IN PROGRESS (A150–A218 done)** *(at 6,654 / 2026-06-14; 364 np=1 candidates remaining)*
   - **⚠️ DEFERRALS + GENUS STUBS at the top of the query — SKIP all every batch:**
     ...
     - `Ptecticus aurifer` (ja=黄色後架虻) — **NEW deferral A217.** That is a Chinese-style name (a soldier fly, Stratiomyidae); needs a verified katakana ja-name before profiling.
   ...
   - **Next batch A219 — from Rhododendron / next alpha** (re-run the np=1 query for the fresh top-24/26 + en detail; alphabet now in the R→S range — many marine inverts/molluscs, fungi, mosses, plants, some birds & fish).
