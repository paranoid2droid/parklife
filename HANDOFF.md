...
1. **species_profile curation — np≥2 tiers ALL DONE. np=1 tier IN PROGRESS (A150–A197 done)** *(at 6,124 / 2026-06-10; 894 np=1 candidates remaining)*
   - **⚠️ SKIP `Latona bicolor`** (ja=動物界 junk placeholder; it is a Donacidae bean clam but its katakana name could not be confirmed — DEFERRED, sits at the top of the np=1 query). Needs a verified ja-name before profiling; do NOT profile against 動物界.
   - **Next batch A198 — verified clean top-24 (np=1, from DB query, SKIPPING Latona bicolor): Liriomyza sativae, Lissachatina fulica, Lista ficki, Lithospermum erythrorhizon, Lithospermum murasaki, Lithurgus collaris, Littorina mandshurica, Livistona boninensis, Lixus maculatus, Lixus moiwanus, Lobelia boninensis, Lobelia inflata, Lobophorodes obscuraria, Loliolus japonica, Lomographa simplicior, Longitarsus holsaticus, Lonicera morrowii, Lophura nycthemera, Lottia lindbergi, Lottia tenuisculpta, Loxoblemmus magnatus, Loxocalyx ambiguus, Loxogramme grammitoides, Lucanus gamunus.** (Re-run the np=1 query for fresh en detail before writing. ⚠️ HOMONYM: Lithospermum erythrorhizon & L. murasaki BOTH ja=ムラサキ — erythrorhizon is the true ムラサキ/red gromwell (dye root 紫根); verify/disambiguate murasaki before profiling. Notables: Lissachatina fulica アフリカマイマイ = INVASIVE giant African snail (rat-lungworm vector — handle warning); Lophura nycthemera ハッカン = Silver Pheasant (bird); Livistona boninensis オガサワラビロウ + Lobelia boninensis オオハマギキョウ = Ogasawara endemics; Lonicera morrowii キンギンボク (fly honeysuckle, berries toxic); Lobelia inflata セイヨウミゾカクシ = Indian tobacco, toxic (en junk "Lowbelia"→fix); Loliolus japonica ジンドウイカ = squid; Lucanus gamunus ミクラミヤマクワガタ = Mikura stag beetle endemic.)
