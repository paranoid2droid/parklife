...
1. **species_profile curation — np≥2 tiers ALL DONE. np=1 tier IN PROGRESS (A150–A195 done)** *(at 6,076 / 2026-06-10; 942 np=1 candidates remaining)*
   - **Next batch A196 — verified clean top-24 (np=1, from DB query): Lathraea japonica, Lathyrus aphaca, Lathyrus quinquenervius, Latona bicolor, Laufeia aenea, Lavandula × intermedia, Lejeunea discreta, Lejeunea flava, Lejeunea parva, Lemmaphyllum microphyllum, Lepas anatifera, Lepas anserifera, Lepidepistomus elegantulus, Lepidium africanum, Lepidium sativum, Lepidodactylus lugubris, Lepidotrigla japonica, Lepiota castanea, Lepiota fusciceps, Lepisorus superficialis, Lepista graveolens, Leptogium azureum, Leptospermum scoparium, Lepyrus japonicus.** (Re-run the np=1 query for fresh en/zh detail before writing; Lavandula ×intermedia = Lavandin/lavender, Lepidium sativum = Garden Cress, Lepas anatifera/anserifera = Goose Barnacles, Leptospermum scoparium = Mānuka, Lepidodactylus lugubris = Mourning Gecko (parthenogenetic), Lathyrus = vetchlings; ⚠️ Lepiota castanea/fusciceps = TOXIC dapperlings (amatoxin risk). `Lavandula × intermedia` has a `×` in sciname — robust-rekey handles it but verify it matched.)
