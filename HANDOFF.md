...
1. **species_profile curation — np≥2 tiers ALL DONE. np=1 tier IN PROGRESS (A150–A191 done)** *(at 5,980 / 2026-06-10; 1,038 np=1 candidates remaining)*
   - **Next batch A192 — verified clean top-24 (np=1, from DB query): Hypena indicatalis, Hypena stygiana, Hypena zilla, Hypersypnoides submarginata, Hypholoma lateritium, Hypocarea conspicua, Hypocrea dipterobia, Hypomesus nipponensis, Hyposidra talaca, Hystrichoscelus spathanum, Iambia japonica, Ictalurus punctatus, Idaea auricruda, Idaea imbecilla, Idaea muricata, Idaea sakuraii, Idiochlora ussuriaria, Idotea metallica, Ilex cornuta, Ilex geniculata, Ilex goshiensis, Ilex micrococca, Indigofera tinctoria, Indocalamus tessellatus.** (Re-run the np=1 query for fresh en/zh detail before writing; Hypomesus nipponensis = ワカサギ Japanese smelt (food fish); Ictalurus punctatus = Channel Catfish (INVASIVE); Hypholoma lateritium = Brick Cap mushroom; Indigofera tinctoria = True Indigo (dye); 4 Ilex hollies; Indocalamus tessellatus = large-leaf bamboo; 4 Idaea geometrid waves.)
