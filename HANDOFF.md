...
1. **species_profile curation — np≥2 tiers ALL DONE. np=1 tier IN PROGRESS (A150–A222 done)** *(~6,758 / 2026-06-14; 260 np=1 candidates remaining)*
   ...
   - **Next batch A223 — from Sinanodonta calipygos / next alpha** (re-run the np=1 query for the fresh top-26 + en detail; alphabet now in the S range — molluscs/bivalves, moths, fungi, plants, fish, some birds).
