...
1. **species_profile curation — np≥2 tiers ALL DONE. np=1 tier IN PROGRESS (A150–A182 done)** *(at 5,764 / 2026-06-08; 1,254 np=1 candidates remaining)*
   - **Next batch A183 — verified clean top-24 (np=1, from DB query): Eubrianax granicollis, Eubrianax ramicornis, Eucoenogenes ancyrota, Eucyclodes difficta, Eucyclodes infracta, Eudigraphis kinutensis, Eugalta albimarginalis, Eugoa grisea, Euhadra amaliae, Euhadra brandtii, Euhadra eoa, Euhadra sandai, Eulithis convergenata, Eulophopalpia pauperalis, Eumerus japonicus, Eumeta minuscula, Eumeta variegata, Eumicrotremus awae, Euonymus boninensis, Euonymus sachalinensis, Euops pustulosus, Euphorbia ebracteolata, Euphyia cineraria, Eupithecia clavifera.** (Re-run the np=1 query for fresh en/zh detail before writing; 4 Euhadra = Japanese land snails; Eumeta = bagworm moths; Euonymus boninensis = Ogasawara endemic spindle; Euphorbia ebracteolata = toxic spurge latex; Eumicrotremus awae = lumpfish.)
