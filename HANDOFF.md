...
1. **species_profile curation — np≥2 tiers ALL DONE. np=1 tier IN PROGRESS (A150–A180 done)** *(at 5,716 / 2026-06-06; 1,302 np=1 candidates remaining)*
   - **Next batch A181 — verified clean top-24 (np=1, from DB query): Elysia marginata, Emarginula fragilis, Emilia javanica, Enarmonia decor, Endomychus gorhami, Endotricha kuznetzovi, Engina mendicaria, Engyprosopon grandisquama, Enkianthus cernuus, Enneapterygius etheostomus, Ennomos nephotropa, Ennucula niponica, Ennucula tenuis, Entoloma murrayi, Entomacrodus caudofasciatus, Entomacrodus striatus, Eopachylopus ripae, Eparchus yezoensis, Ephemera strigata, Epiblema sugii, Epilepia dentatum, Epilichas atricolor, Epipomponia nawai, Epipremnum aureum.** (Re-run the np=1 query for fresh en/zh detail before writing; Epipremnum aureum = pothos/golden pothos houseplant, toxic if eaten.)
