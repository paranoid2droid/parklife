...
1. **species_profile curation — np≥2 tiers ALL DONE. np=1 tier IN PROGRESS (A150–A181 done)** *(at 5,740 / 2026-06-08; 1,278 np=1 candidates remaining)*
   - **Next batch A182 — verified clean top-24 (np=1, from DB query): Epipterygium tozeri, Epirhyssa japonica, Epiricania hagoromo, Epitrix hirtipennis, Epuraea distincta, Eranthis pinnatifida, Eremochloa ophiuroides, Ericerus pela, Eriocaulon decemflorum, Eriocaulon heleocharioides, Eriocaulon taquetii, Eriocheir ogasawaraensis, Eriovixia pseudocentrodes, Erodium moschatum, Erronea errones, Eruca vesicaria, Erysimum cheiranthoides, Erysiphe verniciferae, Erythrina variegata, Erythroplusia rutilifrons, Eschatarchia lineata, Etrema subauriformis, Etrumeus micropus, Eubranchus inabai.** (Re-run the np=1 query for fresh en/zh detail before writing; Eruca vesicaria = arugula/rocket salad green; Eranthis pinnatifida = セツブンソウ, Japanese spring ephemeral; Erythrina variegata = coral tree, seeds toxic-alkaloid; Ericerus pela = Chinese white wax scale insect.)
