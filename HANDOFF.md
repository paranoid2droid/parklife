...
1. **species_profile curation — np≥2 tiers ALL DONE. np=1 tier IN PROGRESS (A150–A192 done)** *(at 6,004 / 2026-06-10; 1,014 np=1 candidates remaining)*
   - **Next batch A193 — verified clean top-24 (np=1, from DB query): Indocrassatella oblongata, Indoplanorbis exustus, Inegocia japonica, Inosperma cookei, Inosperma maculatum, Intybia pelegrini, Ipomoea alba, Ipomoea cairica, Ipomoea pes, Ipomoea quamoclit, Irus ishibashianus, Irus macrophylla, Isodontia harmandi, Isognomon legumen, Isognomon perna, Isonychia japonica, Isoteinon lamprospilus, Istiblennius edentulus, Istigobius campbelli, Istigobius hoshinonis, Ixora chinensis, Jacquemontia tamnifolia, Jankowskia fuscaria, Japananus hyalinus.** (Re-run the np=1 query for fresh en/zh detail before writing; Ipomoea alba = Moonflower, Ipomoea cairica = Mile-a-minute vine (invasive), Ipomoea quamoclit = Cypress Vine; 2 Inosperma = Inocybe fibrecaps (TOXIC muscarine); Ixora chinensis = Chinese Ixora; Isoteinon lamprospilus = a skipper butterfly; Indoplanorbis = ramshorn snail (schistosome host).)
