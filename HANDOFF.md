...
1. **species_profile curation — np≥2 tiers ALL DONE. np=1 tier IN PROGRESS (A150–A185 done)** *(at 5,836 / 2026-06-08; 1,182 np=1 candidates remaining)*
   - **Next batch A186 — verified clean top-24 (np=1, from DB query): Freesia refracta, Fritillaria thunbergii, Fromia monilis, Fromundus pygmaeus, Frullania ericoides, Fulgoraria megaspira, Fulvia mutica, Fusinus salisburyi, Gahnia tristis, Galathea orientalis, Galerita orientalis, Galeruca extensa, Galium kamtschaticum, Galium verum, Gallinago megala, Gallinago stenura, Galloisia inflata, Gavia adamsii, Geastrum mirabile, Geastrum pectinatum, Geastrum saccatum, Gekko hokouensis, Gelatinipulvinella astraeicola, Gelochelidon nilotica.** (Re-run the np=1 query for fresh en/zh detail before writing; Freesia refracta = freesia; Fritillaria thunbergii = 浙贝母 medicinal; Galium verum = lady's bedstraw; 2 Gallinago snipe + Gavia adamsii Yellow-billed Loon + Gelochelidon nilotica Gull-billed Tern = BIRDS (+eBird); 3 Geastrum earthstars; Gekko hokouensis = gecko; Fromia monilis = Necklace Sea Star.)
