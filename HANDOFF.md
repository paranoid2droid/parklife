...
1. **species_profile curation — np≥2 tiers ALL DONE. np=1 tier IN PROGRESS (A150–A194 done)** *(at 6,052 / 2026-06-10; 966 np=1 candidates remaining)*
   - **Next batch A195 — verified clean top-24 (np=1, from DB query): Lactarius chrysorrheus, Lactarius subplinthogalus, Lactifluus subvellereus, Lactoria diaphana, Lactuca sativa, Laelia coenosa, Laevicaulis alte, Lagenaria siceraria, Lagidina irritans, Lagocephalus cheesemanii, Lagocephalus spadiceus, Lagostomus maximus, Lamium hybridum, Lamoria glaucalis, Lamprocapnos spectabilis, Lanzia echinophila, Laportea cuspidata, Larus glaucoides, Lasius niger, Lasius sakagamii, Lasius talpa, Lasius umbratus, Lassaba nikkonis, Lateolabrax latus.** (Re-run the np=1 query for fresh en/zh detail before writing; Lactuca sativa = Lettuce, Lagenaria siceraria = Bottle Gourd, Lamprocapnos spectabilis = Bleeding Heart, Larus glaucoides = Iceland Gull (+eBird), 4 Lasius ants, 2 Lagocephalus pufferfish (TTX TOXIC), Lactoria diaphana = boxfish, Laportea cuspidata = stinging nettle. ⚠️ Lactarius/Lactifluus milkcaps — some toxic/acrid.)
