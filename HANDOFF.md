...
1. **species_profile curation — np≥2 tiers ALL DONE. np=1 tier IN PROGRESS (A150–A189 done)** *(at 5,932 / 2026-06-10; 1,086 np=1 candidates remaining)*
   - **Next batch A190 — verified clean top-24 (np=1, from DB query): Hemidactylus frenatus, Hemigrapsus penicillatus, Hemigymnus fasciatus, Hemitrichia decipiens, Hermania orca, Hermonassa arenosa, Hernandia nymphaeifolia, Herpetogramma rudis, Heteranthera reniformis, Heterarmia costipunctaria, Heterocentrotus mamillatus, Heterocladium capillaceum, Heterodontus japonicus, Heteromacoma irus, Heterophyllium nemorosum, Heteroscyphus argutus, Hexabranchus lacer, Hiatella arctica, Hibiscus arnottianus, Hibiscus glaber, Hibiscus hamabo, Hibiscus tetraphyllus, Himacerus apterus, Hippocampus coronatus.** (Re-run the np=1 query for fresh en/zh detail before writing; Hemidactylus frenatus = Common House Gecko; Heterodontus japonicus = Japanese Bullhead Shark; Heterocentrotus mamillatus = Slate-pencil Urchin; Hexabranchus = Spanish Dancer nudibranch; Hippocampus coronatus = Crowned Seahorse; 4 Hibiscus incl. hamabo & arnottianus; Hemigrapsus penicillatus = brush-clawed shore crab.)
